          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {["Java", "Java spring", "JavaScript", "Node.js", "Python", "PHP", "SQL", "HTML/CSS", "Figma", "WLangage", "PC soft", "Java spring", "C++", "C#", "C", "Android Java/Kotlin", "Window serveur", "Linux", "Docker", "Type script", "Git", "Virtual box", "Unity", "WireShark", "Fiddler", "Scala"].map((skill) => (
